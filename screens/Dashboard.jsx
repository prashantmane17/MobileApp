...
const banners = [
  ...
  },
  {
    id: "3",
    image:
      "https://img.freepik.com/premium-vector/buy-1-get-1-free-banner-design-template_96807-605.jpg",
  },
];
...
const deals = [
  ...
  },
  {
    ...
    discount: "15% off",
    image:
      "https://m.media-amazon.com/images/I/61Qe0euJJZL._AC_UF1000,1000_QL80_.jpg",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    discount: "25% off",
    image:
      "https://m.media-amazon.com/images/I/61vNo+aPWUL._AC_UF1000,1000_QL80_.jpg",
  },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        >
          {categories.map((category, index) => (
            <CategoryIcon
              ...
              onPress={() => {
                if (category.label === "Mobiles") {
                  navigation.navigate("MobileSection");
                } else if (category.label === "Home") {
                  navigation.navigate("CustomeScreen");
                } else {
        ...
        <WinterEssentials navigatison={navigation} />
      </ScrollView>
